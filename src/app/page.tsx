  ...
  return (
    <div className="max-w-4xl p-6 bg-white rounded-lg">
      ...
      <p className="text-gray-600 mb-6">
        ...
        for the equivalent iframe request. In some cases, you will need to pass
        extra parameters to Rill in order to support a specific feature such as
        Navigation and Row Access Policies.
      </p>
      <p className="text-grey-600 mb-6">
        The actual iframe request issued on the server can be found at{" "}
      ...
      <div className="mb-8">
        ...
        <ul className="space-y-4">
          <li>
            <a href="/views/custom-view" className="text-indigo-600 underline">
              Embed Explore dashboard
            </a>
            : An embed dashboard that defaults to the Explore page view.
            Navigation to other types of views is allowed.
          </li>
          {/* <li>
            <a
          ...
          <li>
            <a href="/views/canvas" className="text-indigo-600 underline">
              Canvas dashboard
            </a>
      ...
      <div className="mb-8">
        ...
        <ul className="space-y-4">
          <li>
            ...
            : Navigation to other dashboards outside of the requested dashboard
            is enabled. See the top of the embed iframe.
          </li>
          <li>
            <a
            ...
            : Adding a few lines to your dashboard allows you to disable the
            pivot view from your viewers. Please refer to the{" "}
            <a
      ...
      <div className="mb-8">
        ...
        <ul className="space-y-4">
          <li>
            ...
            : Basic row access policy dashboard using a dimension mapping file.
            Please refer to our{" "}
            <a
          ...
          <li>
            ...
            parameter in an iframe request to utilize custom variables in your
            row access policies. Please refer to our{" "}
            <a
              href="https://docs.rilldata.com/integrate/embedding"
              className="text-indigo-600 underline"
            >
